...
import { updateShippingOrderAction } from "../../../redux/slices/orders/ordersSlice";

const UpdateOrders = () => {
  //get the id from the params/ url website
  const { id } = useParams();
  ...
  const onChange = (e) => {
    ...
    dispatch(updateShippingOrderAction({ status: e.target.value, id }));
