...
const Product = () => {
  ...
  const addToCartHandler = () => {
    ...
    //check if the user selected the color and sizes
    if (selectedColor === "") {
      return Swal.fire({
        icon: "error",
        title: "Opsss..",
          ...
          <div className="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
            ...
            <div>
              {product?.QuantityLeft <= 0 ? (
                <p className="bg-red-400 p-5 text-center rounded-xl  font-bold ml-4 ">
                  {" "}
            ...
            <>
              ...
              {product?.QuantityLeft <= 0 ? (
                <button
                  style={{ cursor: "none" }}
                  disabled
                  className="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-gray-500 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                >
                  Add to cart
                </button>
              ) : (
